...
class TjscSpiderSpider(scrapy.Spider):
    ...
    initial_date = datetime(2023, 5, 1)
    final_date = datetime(2023, 7, 31)    
    ...
    def parse(self, response):
        ...
        # while str(self.initial_date) != '2023-08-01':
    ...
    def parse_data(self, response):
        ...
        print('---------------------------------------------------------------------------------------------------')
        print()
        print(f'SCRAPED {self.i}  TIME  {datetime.datetime.now()-self.beginning_time}')
        print()
        print('---------------------------------------------------------------------------------------------------')
        self.i += 1
        yield data
