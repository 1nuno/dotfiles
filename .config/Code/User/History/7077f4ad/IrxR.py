...
class TjscSpiderSpider(scrapy.Spider):
    ...
    final_date = datetime(2023, 11, 30)    
    ...
    def parse(self, response):
        ...
        for link in links:
            yield scrapy.Request(url='http://www.httpbin.org/status/404', headers=self.headers, callback=self.parse_data, meta={'page': response.meta.get('page')}, errback=self.onerror,
                dont_filter=True)
        ...
        #     yield scrapy.Request(url='https://www.uc.pt/dsjf', headers=self.headers, callback=self.parse, meta={'page': i}, method="POST", body=self.payload, errback=self.onerror)
    ...
    def onerror(self, failure):
        print('gggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggg')
