...
def get_item_list():
    try:
        ...
        get_type = request_body.get('get_type','one_query')

        if get_type == 'one_query':
            ...
            response = {'status': StatusCodes['success'],
                        ...
                        'data': data}
        elif get_type == 'many_queries':
            pass

        else:
            response = {'status': StatusCodes['bad_request_error'],
                        'message': "The get_type value you provided is not valid.",
                        'data': data}
