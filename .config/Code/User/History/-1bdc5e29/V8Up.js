...
const toggleMobileMenu = () => {
  ...
  if (mobileMenuVisible == false) {
    mobileMenu.style.animationName = 'bounceInLeft';
    mobileMenu.style.webkitAnimationName = 'bounceInLeft';
...
const shareMobileMenu = () => {
  ...
  if (shareMenuVisible == false) {
    shareMenu.style.animationName = 'bounceInLeft';
    shareMenu.style.webkitAnimationName = 'bounceInLeft';
